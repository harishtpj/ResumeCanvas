    ...
    <div class="max-w-[1280px] mx-auto px-4 md:px-8 grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div class="col-span-1 lg:col-span-9 flex flex-col gap-8 text-left">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          ...
          <div class="bg-primary text-white p-6 rounded-3xl flex flex-col justify-between shadow-lg shadow-primary/10 relative overflow-hidden group">
            <div class="absolute -right-6 -bottom-6 w-24 h-24 bg-white/5 rounded-full blur-2xl group-hover:scale-125 transition-transform duration-700 font-sans"></div>
            <div>
...
<!--              <ChevronRight v-if="!isOptimizingScore" class="w-3.5 h-3.5" />-->
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <div class="w-12 h-12 rounded-full bg-white shadow-sm flex items-center justify-center text-primary group-hover:scale-110 transition-transform duration-300">
                <Plus class="w-6 h-6" />
              </div>
              <span class="font-bold text-sm text-on-surface-variant group-hover:text-primary transition-colors">Create New Portfolio</span>
            </button>
            ...
            <PortfolioCard
              ...
              @share="(title) => emit('share-portfolio', title)"
        ...
        <div class="bg-indigo-50 border border-indigo-100 rounded-[2rem] p-6 md:p-10 relative overflow-hidden group">
          ...
          <div class="relative z-10 max-w-2xl text-left">
            <div class="inline-flex items-center gap-1.5 bg-primary/10 text-primary px-3 py-1 rounded-full text-[11px] font-bold mb-4 select-none">
